...
object PluginLoader {
    ...
    //public functions
    fun getPlugIDList(): List<UUID> = plugIDList.toList() // return a copy of the list rather than the list itself
    fun getPluginMap(): Map<UUID, MyPlugin> = pluginObjectMap.toMap() // return a copy of the Map rather than the list itself
